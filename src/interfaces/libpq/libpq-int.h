...
struct pg_conn
{
	...
	char	   *require_wal_receiver;	/* reject standby w/o live walreceiver */
	...
	bool	   replication_checked;	/* replication check done for current host */
	...
	bool		require_wal_receiver_parsed;
